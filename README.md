...
It should not absorb every living archive, donor rule, branch prototype, or
machine trace into one root story.
...
This repository routes readers toward the wider ecosystem layers:

- theory;
- practice;
- publication;
- governance and donor logic;
- design and philosophy branches;
- human-facing research branches.

The donor map for that split now lives in
[`terra-legal/GITHUB_LAYER_MODEL.md`](https://github.com/AIUZ-Terra-Codex-EcoSystem/terra-legal/blob/main/GITHUB_LAYER_MODEL.md).
