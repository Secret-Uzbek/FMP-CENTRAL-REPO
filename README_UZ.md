...
**FMP isbotlaydi:** Sizga milliardlar kerak emas. Sizga qarash, struktura va to'xtovsiz ijro kerak.
...
1. Loyiha yo'nalishi uchun [**ROADMAP.md**](ROADMAP.md) bilan tanishing
2. Navigatsiya uchun [**META-INDEX.md**](META-INDEX.md) ni o'rganing
3. Muayyan mavzular uchun bog'langan repozitoriyalarni o'rganing
4. Iqtibos keltirish qoidalari uchun [**CITATION.cff**](CITATION.cff) ni o'qing

### Dasturchilar uchun

1. Asosiy protokollar uchun `/NULLO` katalogini tekshiring
2. Dinamik indekslash tizimlari uchun `/living-index` ni tekshiring
3. Challenge arxivlari uchun `/competitions-log` ni ko'rib chiqing
4. Avtomatlashtirish namunalari uchun `.github/workflows` ga qarang
...
To'liq iqtibos metadata uchun [**CITATION.cff**](CITATION.cff) ga qarang.
...
2. Xususiyat tarmog'ini **yarating**
3. O'zgarishlaringizni **commit** qiling
4. Tarmog'iga **push** qiling
...
Versiya tarixi uchun [**Relizlar**](https://github.com/Secret-Uzbek/FMP-CENTRAL-REPO/releases) ni tekshiring.
...
Bu shunchaki repozitoriy emas. Bu to'siqlar qarashnini to'xtatmasligining isboti. Innovatsiya milliardlarni talab qilmasligining isboti. Fan hamma uchun, faqat yaxshi moliyalashtirilganlar uchun emasligining isboti.

**Noldan sayyora miqyosigacha. Qamoqxonadan dunyoga.**
...
[![Yulduz qo'ying](https://img.shields.io/github/stars/Secret-Uzbek/FMP-CENTRAL-REPO?style=social)](https://github.com/Secret-Uzbek/FMP-CENTRAL-REPO)
