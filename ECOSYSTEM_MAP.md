...
## Architecture
```
FMP-CENTRAL-REPO (L7 — Core Hub)
├── NULLO Protocol     — zero-budget infrastructure
├── PLT Layer          — uz/ru/en/de semantic bridges  
├── UCOMM              — living-lab communication
└── FMP Core           — fractal metascience theory

Agents:
├── Terra   [L7] — core intelligence
├── Tomiris [L6] — strategy & ecosystem
├── Shirak  [L5] — research & publications
└── Roxana  [L4] — PLT & linguistics
```
